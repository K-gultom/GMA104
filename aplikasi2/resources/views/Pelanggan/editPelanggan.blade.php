                        ...
                        <div class="card-body">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="alamat" id="" cols="10" rows="3" class="form-control @error('alamat') is-invalid @enderror" placeholder="Masukkan Alamat Pelanggan...">{{ $getPelanggan->alamat }} </textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
